...
import { Checkbox } from 'primereact/checkbox'; // PrimeReact Checkbox
          ...
          <div>
            ...
            <form>
              <div className="space-y-6">
                <div>
                  {/* PrimeReact's Label equivalent */}
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Email <span className="text-error-500">*</span>
                  </label>
                  <InputText placeholder="info@gmail.com" className="w-full" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Checkbox checked={isChecked} onChange={(e) => setIsChecked(e.checked ?? false)} />
