...
const initialOrders: Order[] = [
  ...
  },
  {
    ...
    price: 300000,
    imageUrl:
      'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/4ae3c0d4-1573-4842-9b01-5589cb11f359/NIKE+VOMERO+18.png',
  },
];
            ...
            >
              ...
              <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                <select
                  ...
                  className="h-10 w-full rounded-lg border border-gray-200 bg-[#E6F2F5] px-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#A8DCE7] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
                >
              ...
              <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">
                <button
                  ...
                  className="text-[#A8DCE7] hover:text-[#95C8D2] dark:text-[#A8DCE7] dark:hover:text-[#95C8D2] mr-4"
                  title="View"
                >
                ...
                <button
                  ...
                  disabled={order.isCancelled || order.status === 'delivering'}
                  className={`mr-4 ${
                    order.isCancelled || order.status === 'delivering'
                      ? 'text-gray-400 dark:text-gray-600 cursor-not-allowed'
                      : 'text-[#A8DCE7] hover:text-[#95C8D2] dark:text-[#A8DCE7] dark:hover:text-[#95C8D2]'
                  }`}
                  title="Create"
                >
...
export default function OrderManagement() {
  ...
  const handleCancel = (id: number) => {
    ...
    if (order?.status === 'delivering') {
      showAlert(
        'error',
        'Cannot Cancel',
        'Orders in delivery cannot be cancelled.'
      );
      return;
    }
    setOrders((prev) =>
  ...
  const handleCreateOrder = (order: Order) => {
    if (order.status === 'delivering') {
      showAlert(
        'error',
        'Cannot Create',
        'Orders in delivery cannot be modified.'
      );
      return;
    }
  ...
  const handleConfirmOrder = () => {
    ...
    showAlert(
      'success',
      'Success',
      `Order #${selectedOrder.id} has been created successfully.`
    );
  };
      ...
      <div className="mb-6">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="h-12 w-full rounded-lg border border-gray-200 bg-[#E6F2F5] pl-12 pr-4 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#A8DCE7] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:placeholder:text-gray-500"
          />
        </div>
      </div>
                    ...
                    <span
                      className={`px-2 py-1 text-xs rounded-full font-medium ${
                        viewOrder.status === 'delivered'
                          ? 'bg-[#E6F2F5] text-[#A8DCE7] dark:bg-[#E6F2F5] dark:text-[#A8DCE7]'
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="h-12 w-full rounded-lg border border-gray-200 bg-[#E6F2F5] px-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#A8DCE7] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-[#E6F2F5] px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#A8DCE7] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
                />
              </div>
